...
<style>
.about-hero { width:100%; max-height:320px; object-fit:cover; border-radius:10px; margin:1rem 0 1.5rem; display:block; }
...
<main>
    ...
    <!-- todb you're gonna have to add stuff yourself -->
    ...
    <!--
    copy block for cards cuz i'm lazy:
    <div class="credit-card">
        <h4>Name</h4>
